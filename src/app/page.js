    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="max-w-2xl mx-auto mt-8 text-gray-500 flex flex-col gap-4">
          ...
          <p>
            Join the <b>QuickEats</b> family today and experience the convenience of delicious meals delivered right to your doorstep. Whether you're dining solo, with family, or hosting a gathering, QuickEats is your go-to for quality food and exceptional service. Say goodbye to long lines and busy kitchens - with <b>QuickEats</b>, good food is just a click away.
          </p>
        </div>
      </section>
